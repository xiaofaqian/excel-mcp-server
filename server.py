...
# 导入工具模块
from tools import read_excel_file, get_excel_summary, search_excel_data, insert_excel_row, delete_excel_row, insert_cell_text
...
mcp.tool()(insert_excel_row)
mcp.tool()(delete_excel_row)
mcp.tool()(insert_cell_text)
